...
pub fn run() {    let db_state = DbState::new().expect("Failed to initialize database");
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(lan_wrap_invoke_handler(tauri::generate_handler![
            ...
            commands::print_a4_document,
            commands::test_a4_printer,
            ...
            cloudsync::cloud_cmds::cloud_push_catalog,
            cloudsync::cloud_cmds::cloud_reconcile_stock,
            ...
            cloudsync::cloud_cmds::cloud_create_route,
            cloudsync::cloud_cmds::cloud_delete_route,
            cloudsync::cloud_cmds::cloud_field_order_detail,
            cloudsync::cloud_cmds::cloud_field_order_edit,
            cloudsync::cloud_cmds::cloud_field_order_delete,
            cloudsync::cloud_cmds::cloud_route_detail,
            cloudsync::cloud_cmds::cloud_update_route,
            cloudsync::cloud_cmds::cloud_set_client_visit_days,
